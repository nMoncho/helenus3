...
abstract class AbstractSeqCodecSpec[Coll[_] <: scala.collection.Seq[?]](name: String)(
...
end AbstractSeqCodecSpec

class BufferCodecSpec extends AbstractSeqCodecSpec[mutablecoll.Buffer]("BufferCodec"):
    override protected val codec: Codec[mutablecoll.Buffer[Int]] =
        Codec[mutablecoll.Buffer[Int]]

    override protected val sCodec: Codec[mutablecoll.Buffer[String]] =
...
class IndexedSeqCodecSpec extends AbstractSeqCodecSpec[mutablecoll.IndexedSeq]("IndexedSeqCodec"):
    override protected val codec: Codec[mutablecoll.IndexedSeq[Int]] =
        Codec[mutablecoll.IndexedSeq[Int]]

    override protected val sCodec: Codec[mutablecoll.IndexedSeq[String]] =
        Codec[mutablecoll.IndexedSeq[String]]
end IndexedSeqCodecSpec

class ListCodecSpec extends AbstractSeqCodecSpec[List]("ListCodec"):
    override protected val codec: Codec[List[Int]] = Codec[List[Int]]

    override protected val sCodec: Codec[List[String]] = Codec[List[String]]

class SeqCodecSpec extends AbstractSeqCodecSpec[Seq]("SeqCodec"):
    override protected val codec: Codec[Seq[Int]] = Codec[Seq[Int]]

    override protected val sCodec: Codec[Seq[String]] = Codec[Seq[String]]

class VectorCodecSpec extends AbstractSeqCodecSpec[Vector]("VectorCodec"):
    override protected val codec: Codec[Vector[Int]] = Codec[Vector[Int]]

    override protected val sCodec: Codec[Vector[String]] = Codec[Vector[String]]
