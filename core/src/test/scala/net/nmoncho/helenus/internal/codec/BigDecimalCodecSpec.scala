...
class BigDecimalCodecSpec
    ...
    override protected val codec: Codec[BigDecimal] = Codec[BigDecimal]
    ...
    override def toJava(t: BigDecimal): java.math.BigDecimal =
        if t == null then null else t.bigDecimal

end BigDecimalCodecSpec
