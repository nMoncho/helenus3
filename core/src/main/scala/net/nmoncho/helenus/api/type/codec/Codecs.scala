...
object Codecs:
    ...
    val stringCodec: TypeCodec[String] =
        com.datastax.oss.driver.api.core.`type`.codec.TypeCodecs.TEXT
    ...
    def mutableBufferOf[T](inner: TypeCodec[T]): TypeCodec[mutablecoll.Buffer[T]] =
        collection.mutable.BufferCodec.frozen(inner)
    ...
    def mutableIndexedSeqOf[T](inner: TypeCodec[T]): TypeCodec[mutablecoll.IndexedSeq[T]] =
        collection.mutable.IndexedSeqCodec.frozen(inner)
    ...
    def mutableMapOf[K, V](
        ...
        collection.mutable.MapCodec.frozen(keyInner, valueInner)
