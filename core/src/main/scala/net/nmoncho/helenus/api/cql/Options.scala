...
trait Options[In, Out]:
    ...
    def withIgnoreNullFields(ignore: Boolean): Self =
        withOptions:
            options.copy(pstmtOptions = options.pstmtOptions.copy(ignoreNullFields = ignore))
    ...
    def withExecutionProfile(profile: DriverExecutionProfile): Self =
        withOptions:
            options.copy(bstmtOptions = options.bstmtOptions.copy(profile = Some(profile)))
    ...
    def withTracing(enabled: Boolean): Self =
        withOptions:
            options.copy(bstmtOptions = options.bstmtOptions.copy(tracing = enabled))
    ...
    def withTimeout(timeout: Duration): Self =
        withOptions:
            options.copy(bstmtOptions = options.bstmtOptions.copy(timeout = Some(timeout)))
    ...
    def withPageSize(pageSize: Int): Self =
        withOptions:
            options.copy(bstmtOptions = options.bstmtOptions.copy(pageSize = pageSize))
