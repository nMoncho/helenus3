...
sealed trait TokenCodec[T <: Token] extends Codec[T]
...
object TokenCodec:
    ...
    /** [[TypeCodec]] implementation for [[Token]]
      ...
      */
    object TokenCodec extends Codec[Token]:

        override val getJavaType: GenericType[Token] = GenericType.of(classOf[Token])

        override val getCqlType: DataType = DataTypes.BIGINT // Murmur3-leaning
    ...
    object ByteOrderedTokenCodec
        extends MappingCodec[ByteBuffer, ByteOrderedToken](TypeCodecs.BLOB, GenericType.of(classOf[ByteOrderedToken]))
    ...
    end ByteOrderedTokenCodec

    object Murmur3TokenCodec
        extends MappingCodec[java.lang.Long, Murmur3Token](TypeCodecs.BIGINT, GenericType.of(classOf[Murmur3Token]))
    ...
    end Murmur3TokenCodec

    object RandomTokenCodec
        extends MappingCodec[BigInteger, RandomToken](TypeCodecs.VARINT, GenericType.of(classOf[RandomToken]))
